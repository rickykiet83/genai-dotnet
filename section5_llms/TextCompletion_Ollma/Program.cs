...
// Local model loading and inference can exceed HttpClient's default 100-second timeout.
...
IChatClient client = new OllamaApiClient(httpClient, "llama3.2");
...
//
// ChatResponse responseAnalysis = await client.GetResponseAsync(analysisPrompt).ConfigureAwait(false);
//
